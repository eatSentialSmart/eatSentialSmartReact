...
const HomepageLayout = () => (
    <Responsive>
        <Segment inverted color='blue' vertical style={{ padding: '2em 0em', marginTop: '16em' }}>
            <Container>
                    ...
                    <Grid.Row>
                        <Grid.Column width={5}>
                            ...
                            <List size="large" link inverted>
                                <List.Item><a href='https://www.linkedin.com/in/hussein-fakhreddine/' target='_blank' rel="noopener noreferrer">
                        ...
                        <Grid.Column width={5}>
                            ...
                            <List size="large" link inverted>
                                <List.Item><a href='https://github.com/eatSentialSmart/eatSentialSmartReact' target='_blank' rel="noopener noreferrer">
